...
df = pd.read_csv(r'/work1/viviane1695/tbb1496/updates/dataframe/chr1_updated_af_vqsr_cleaned.txt', sep='\t')
...
with open('/work1/viviane1695/tbb1496/updates/from_4plot_chr1.txt', 'w') as f:
    for item in [np.round(value_1,2)]:
        f.write("%s\n" % item)

df['Filter_code'] = df['Filter_code'].map({'PASS': 'PASS(83.45%)', '99.80': '99.70-99.80(6.16%)','99.90':'99.80-99.90(5.80%)','100.00':'99.90-100.00(4.59%)'})
df1['Filter_code'] = df1['Filter_code'].map({'PASS': 'PASS(83.45%)', '99.80': '99.70-99.80(6.16%)','99.90':'99.80-99.90(5.80%)','100.00':'99.90-100.00(4.59%)'})
df2['Filter_code'] = df2['Filter_code'].map({'PASS': 'PASS(83.45%)', '99.80': '99.70-99.80(6.16%)','99.90':'99.80-99.90(5.80%)','100.00':'99.90-100.00(4.59%)'})
df3['Filter_code'] = df3['Filter_code'].map({'PASS': 'PASS(83.45%)', '99.80': '99.70-99.80(6.16%)','99.90':'99.80-99.90(5.80%)','100.00':'99.90-100.00(4.59%)'})
...
colors = {'PASS(83.45%)':'tab:blue', '99.70-99.80(6.16%)':'tab:green', '99.80-99.90(5.80%)':'tab:orange', '99.90-100.00(4.59%)':'tab:red'}
...
axis[0,1].legend(title='VQSR Filter \n N=2,179,245', handles=handles, bbox_to_anchor=(1.05, 1), loc='upper left')
...
figure.text(0.5, 0.0, 'TWB1496 (chromosome 1)', ha='center', fontsize=12)
figure.text(0.0, 0.5, 'East Asian(EAS, gnomAD)', va='center', rotation='vertical', fontsize=12)
#plt.show()
figure.savefig('/work1/viviane1695/tbb1496/updates/figure/chr1_twb1496_gnomAD_fourplot_r2.png', bbox_inches="tight", dpi=600)
