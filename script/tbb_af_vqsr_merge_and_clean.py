...
df_twb = pd.read_csv(r'/work1/viviane1695/tbb1496/updates/tbb_subset_conditional_20210618.txt', sep='\t', low_memory=False)

df_AF = pd.read_csv(r'/work1/viviane1695/tbb1496/updates/AF_Category_subset_nonsynonym.txt', sep='\t', low_memory=False)
...
df2.to_csv(r'/work1/viviane1695/tbb1496/updates/dataframe/tbb_updated_af_vqsr_merge.txt', index=False, header=True, sep='\t', mode='a')

###################################################### Clean merged dataframe for regression/scatter plot ########################################################################################

df = pd.read_csv(r'/work1/viviane1695/tbb1496/updates/dataframe/tbb_updated_af_vqsr_merge.txt', sep='\t', low_memory=False)
...
df.to_csv(r'/work1/viviane1695/tbb1496/updates/dataframe/tbb_updated_af_vqsr_cleaned.txt', index=False, header=True, sep='\t', mode='a')
