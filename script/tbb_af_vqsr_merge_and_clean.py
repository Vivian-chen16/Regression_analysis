...
df_twb = pd.read_csv(r'/work1/viviane1695/tbb1496/updated_annotation/tbb_subset_conditional_20210618.txt', sep='\t', low_memory=False)

df_AF = pd.read_csv(r'/work1/viviane1695/tbb1496/updated_annotation/AF_Category_subset_nonsynonym.txt', sep='\t', low_memory=False)
df_AF.columns= ['Chr','Start', 'Ref', 'Alt','AF/MAF_Category']
#df_AF = df_AF.astype({'Start':'int64'})
...
df2.to_csv(r'/work1/viviane1695/tbb1496/updated_annotation/dataframe/tbb_updated_af_vqsr_merge.txt', index=False, header=True, sep='\t', mode='a')

###################################################### Clean merged dataframe for regression/scatter plot ########################################################################################

df = pd.read_csv(r'/work1/viviane1695/tbb1496/updated_annotation/dataframe/tbb_updated_af_vqsr_merge.txt', sep='\t', low_memory=False)
...
df.to_csv(r'/work1/viviane1695/tbb1496/updated_annotation/dataframe/tbb_updated_af_vqsr_cleaned.txt', index=False, header=True, sep='\t', mode='a')
